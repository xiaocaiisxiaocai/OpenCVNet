...
namespace VisionInspection.Vision.Alignment
{
    ...
    public sealed class AlignmentResult
    {
        ...
        public double[] Affine { get; }
        public string Message { get; }

        public AlignmentResult(bool success, double[] affine, string message = null)
        {
            Success = success;
            Affine = affine;
            Message = message;
        ...
        /// <summary>构造 2×3 恒等仿射矩阵，数组顺序为 a00,a01,a02,a10,a11,a12。</summary>
        public static double[] CreateIdentityAffine()
        {
        ...
        public Mat ToMat()
        {
            ...
            m.Set(0, 0, Affine[0]); m.Set(0, 1, Affine[1]); m.Set(0, 2, Affine[2]);
            m.Set(1, 0, Affine[3]); m.Set(1, 1, Affine[4]); m.Set(1, 2, Affine[5]);
            return m;
        }
